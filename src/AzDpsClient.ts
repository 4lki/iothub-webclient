...
export const createHmac = async (key: string, msg: string) => {
...
export class AzDpsClient {
  ...
  async registerDevice() {
    ...
    const url = `${endpoint}?scopeId=${this.scopeId}&deviceId=${
      this.deviceId
    }&deviceKey=${encodeURIComponent(this.deviceKey)}&modelId=${this.modelId}`;
    console.log(url);
