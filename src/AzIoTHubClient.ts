...
export class AzIoTHubClient {
  ...
  async connect() {
    ...
    const password = await generateSasToken(
      `${this.host}/devices/${this.deviceId}`,
      this.key,
      null,
      60
    );
